                                ...
                                <div class="card-body">
                                    <form method="post" action="Add-UpdateStaff" id="createStaffForm" class="row">
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="user_phone_email" id="user_phone_email" value="${param.user_phone_email}" placeholder="Enter phone number" required>
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <select id="staff_major" name="staff_major" class="form-control">
                                                <c:forEach items="${majorCategorys}" var="mCate">
                                                    <option value="${mCate.getMajorCategoryName()}">${mCate.getMajorCategoryName()}</option>
                                                </c:forEach>
                                            </select>
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <textarea type="text" class="form-control" name="staff_education" id="staff_education" required>
                                                ${param.staff_education}
                                            </textarea>
                                        </div>

                                        <div class="form-group mb-3 col-md-6">
                                            <label for="staff_description">Miêu tả ngắn</label>
                                            <textarea class="form-control" name="staff_description" id="staff_description" required>
                                        ...
                                        <div class="form-group  mb-3 col-md-6">
                                            ...
                                            <textarea class="form-control" name="staff_experience" id="staff_experience" required/>${param.staff_experience}</textarea>
                                        </div>
                                        <p>${errorMessage}</p>
