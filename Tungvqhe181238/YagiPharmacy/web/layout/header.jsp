            ...
            <div class="top-bar right">
                <ul>
                    ...
                    <li>
                        ...
                        <c:if test="${sessionScope.userAuth!=null}">
                            <a  href="Logout" class="login-link">Logout</a></li>
                        </c:if>
    ...
    <div class="header-bottom">
        <div class="container">
            <div class="main-content">
                <div class="logo">
                    <img onclick="window.location = 'http://localhost:9999/YagiPharmacy/HomePage'" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0D7dpBePJfDZT-n0aqbnoCSgVrD3GP_vH_Q&s" alt="biolife logo" width="auto" height="120">
                </div>
                <div class="main-menu">
                    <ul>
                        <li><a href="HomePage" class="${requestScope['jakarta.servlet.forward.request_uri'].toString().endsWith("HomePage")?"menu-active":""}">Home</a></li>
                        ...
                        <li><a href="CustomerOrders" class="${requestScope['jakarta.servlet.forward.request_uri'].toString().endsWith("CustomerOrders")?"menu-active":""}">Order History </a></li>
                    </ul>
                    <div class="search">
