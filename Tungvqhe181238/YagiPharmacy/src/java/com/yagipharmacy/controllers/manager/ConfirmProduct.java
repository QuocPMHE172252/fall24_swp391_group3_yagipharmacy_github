...
public class ConfirmProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String subject = curentUser.getUserName() + " have been reject your new product ";
            String url = "http://" + host + ":" + port + request.getContextPath()
                    + "/manager/EditProduct?product_id=" + productId;
            String body = "If you want to see detail click here <a href='" + url + "'>Product Detail</a>. Reason: " + rejectReason;
