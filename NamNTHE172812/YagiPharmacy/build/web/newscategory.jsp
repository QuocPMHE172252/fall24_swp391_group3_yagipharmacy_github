            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="margin: 00px">
                        <li class="breadcrumb-item"><a href="./Home" style="text-decoration: none; color: #007bff">Home </a></li>
                        <li class="breadcrumb-item"><a href="./NewList?index=1" style="text-decoration: none; color: black">News Categories List</a></li>
                    </ol>
                </nav>
