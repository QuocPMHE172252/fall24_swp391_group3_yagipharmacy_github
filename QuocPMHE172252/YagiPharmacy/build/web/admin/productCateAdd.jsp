                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="CategoryAdd" id="addCategoryForm">
                                        ...
                                        <!-- Category Detail -->
                                        <div class="mb-3">
                                            <label for="productCategoryDetail" class="form-label">Category Detail</label>
                                            <textarea class="form-control" id="productCategoryDetail" name="productCategoryDetail" rows="3" placeholder="Enter category detail"></textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="productCategoryLevel" value="1" name="productCategoryLevel" readonly="" placeholder="Enter category level" required>
                                        </div>
