                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseProductType" class="accordion-collapse collapse show" aria-labelledby="headingProductType">
                                        <div class="accordion-body">
                                            <div class="form-check" onclick="submitFilterForm()">
    ...
    <script>
                        ...
                        function createProductCard(product) {
                            ...
                            if(product.productImages.length!=0){
                                imgB64 = product.productImages[0].imageBase64;
                            }
                        ...
                        <div class="card-body" style="display: flex;flex-direction: column;justify-content: center">
                            <a href="ProductDetail?pid=`+product.productId+`" class="btn" style="width: 190px;height: 38px;border-radius: 20px;background-color: #306de4;color: #FFF">Chọn mua</a>
                        </div>
                    </div>`;
                            return newCart;
                        }
                        ...
                        function seeMore(){
                            ...
                            document.getElementById('size_of_page').value = '${size_of_page+4}';
                            document.getElementById('formFilter').submit();
                        }
                        function submitFilterForm(){
                            document.getElementById('see_more').value = 'false';
                            document.getElementById('formFilter').submit();
                        }
    </script>
</html>
