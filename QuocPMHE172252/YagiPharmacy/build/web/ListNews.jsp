                        ...
                        <tr>
                            <td><select class="form-control" id="parent_cate" name="parent_cate" onchange="changeListChild()">
                                    ...
                                    <c:forEach items="${listParentCates}" var="parent">
                                        <option value="${parent.newsCategoryId}">${parent.newsCategoryName}</option>
                                    </c:forEach>
                                </select></td>
                            <td><select class="form-control" id="cateId" name="cateId">
                                    <option value="all">All</option>
                                </select></td>
                            <td><input class="form-control me-2" type="date" name="from"></td>
                            <td><input class="form-control me-2" type="date" name="to"></td>
                            <td><input class="form-control me-2" type="search" placeholder="Tiêu đề" name="title"></td>
                            <td><input class="form-control me-2" type="search" placeholder="Thẻ được gắn" name="hashtag"></td>
