...
<div class="sidebar" data-background-color="dark">
    ...
    <div  class="scroll-wrapper sidebar-wrapper scrollbar scrollbar-inner" style="position: relative;height: 1vh"><div class="sidebar-wrapper scrollbar scrollbar-inner scroll-content" style="height: 1314px; margin-bottom: 0px; margin-right: 0px; max-height: none;">
                        ...
                        <div class="collapse" id="base">
                            <ul class="nav nav-collapse">
                                ...
                                <c:if test="${sessionScope.userAuth!=null&&sessionScope.userAuth.roleLevel==2}">
                                    <li>
                                        <a href="../manager/StaffList">
                                            <span class="sub-item">Staff List</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="Add-UpdateStaff">
