 ...
 * @author author
 */
@WebServlet(name = "SupplierList", urlPatterns = {"/manager/SupplierList"})
public class SupplierList extends HttpServlet implements AuthorizationService{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("pl", pdao.fillterSupplier(status));
