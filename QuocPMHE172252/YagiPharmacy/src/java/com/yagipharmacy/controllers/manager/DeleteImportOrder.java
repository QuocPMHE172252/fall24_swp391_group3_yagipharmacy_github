 ...
 * @author admin
 */
@WebServlet(name = "DeleteImportOrder", urlPatterns = {"/manager/DeleteImportOrder"})
public class DeleteImportOrder extends HttpServlet implements AuthorizationService{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteImportOrder</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteImportOrder at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
