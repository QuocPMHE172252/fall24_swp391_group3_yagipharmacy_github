 ...
 * @author author
 */
@WebServlet(name = "ChangeAccountStatus", urlPatterns = {"/admin/ChangeAccountStatus"})
public class ChangeAccountStatus extends HttpServlet implements AuthorizationService{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            new UserDAO().updateStatusById(uid, status);
            response.sendRedirect("./AccountList");
        } catch (Exception ex) {
            Logger.getLogger(ChangeAccountStatus.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
