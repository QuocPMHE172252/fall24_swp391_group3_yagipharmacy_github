 ...
 * @author author
 */
@WebServlet(name = "CategoryDelete", urlPatterns = {"/admin/CategoryDelete"})
public class CategoryDelete extends HttpServlet implements AuthorizationService{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            new ProductCategoryDAO().updateStatusById(uid, status);
