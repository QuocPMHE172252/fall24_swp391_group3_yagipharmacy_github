                                ...
                                <c:forEach var="pro" items="${bloList}">
                                    <div style="border: 1px solid lightgray;padding: 5px;margin-bottom: 10px">
                                        ...
                                        <div class="latest-product-item">
                                            <a href="NewsDetail?nid=${pro.newsId}" title="product thumbnail" style="width: 45%;"><img src="${pro.newsImage}" alt="" width="100%"></a>
                                            <div class="latest-product-info">
                                                <p class="latest-product-title product-description" style="padding-left: 8px;" ><a href="NewsDetail?nid=${pro.newsId}" class="product-name" style="font-size: 12px;">${pro.newsHashtag}</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
                        ...
                        <div class="product-list">
                            <c:forEach var="p" items="${list}">
                                <div class="product-item" style="padding: 15px;">
                                    <a href="NewsDetail?nid=${p.newsId}" title="product thumbnail" ><img src="${p.newsImage}" alt="" width="100%"></a>
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="NewsDetail?nid=${p.newsId}" class="product-name">${p.newsTitle}</a></h4>
