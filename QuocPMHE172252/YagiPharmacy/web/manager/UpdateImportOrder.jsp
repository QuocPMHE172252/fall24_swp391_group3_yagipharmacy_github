                            ...
                            <div class="modal-body">
                                <form action="UpdateImportOrder" method="post" id="updateForm">
                                    ...
                                    <table class="table">
                                                        <tr>
                                                            <td>Trạng thái</td>
                                                            <td><select type="text" id="submit_processing" name="submit_processing">
                                                        ...
                                                        <tr>
                                                            <td>Số lô</td>
                                                            <td><input type="text" id="submit_batch_code" name="submit_batch_code"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Giá nhập</td>
                                                            <td><input type="number" min="0" step="0.1" id="submit_import_price" name="submit_import_price"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Ngày nhập</td>
                                                            <td><input type="date" min="0" id="submit_import_date" name="submit_import_date"></td>
                                                        </tr>
                                    </table> 
                                </form>
