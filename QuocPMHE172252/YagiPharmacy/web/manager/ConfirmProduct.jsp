...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="ConfirmProduct" id="ConfirmProductForm" class="row">
                                        <input readonly type="hidden" name="product_id" value="${product.productId}">
                                        <input readonly type="hidden" name="getAuthorId" value="${product.getAuthorId()}">
                                        <div class="form-group mb-3 col-md-6">
                                            <label for="product_code">Product Code</label>
                                            <input readonly type="text" class="form-control" name="product_code" 
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <input readonly type="text" class="form-control" name="product_name"
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <select disabled class="form-control" name="product_category"
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <input readonly type="text" class="form-control" name="dosage_form"
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <input readonly type="text" class="form-control" name="product_specification"
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <input readonly type="text" class="form-control" name="product_target"
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <textarea class="form-control" id="product_desciption" readonly=""
                                        ...
                                        <div class="form-group  mb-3 col-md-6">
                                            ...
                                            <select class="form-control-sm" disabled id="suplier_id" name="suplier_id"
                                                    required>
                                        ...
                                        <div class="form-group  mb-3 col-md-6" style="display: block !important;">
                                            <label>Prescription: </label> ${product.isPrescription() ? 'Yes' : 'No' }<br />
                                        ...
                                        <div class="row">
                                            ...
                                            <input id="rejectReason" type="text" name="rejectReason" class="form-control" >
                                            <input id="atuhorId" type="hidden" name="atuhorId" class="form-control" >
                                            <label style="margin-top: 5px;">
                                                Trạng thái kiểm duyệt: Chờ duyệt
                                            </label>
                                        </div>
                                        <p>${errorMessage}</p>
                                        <div class="form-group mb-3 col-md-12">
                                            <input type="submit" name="status" style="width: 100px; margin: 5px" value="Reject" class="btn btn-danger"/>
                                            <input type="submit" name="status" style="width: 120px; margin: 5px" value="Appreoved" class="btn btn-success"/>
        ...
        <script>
            ...
            document.querySelectorAll("#exs_in_drug input readonly[name^='excipient_id_']").forEach(function (input readonly) {
            if (input readonly.value === ex_id) {
            check = false;
            }
            });
            if (check) {
            ...
            rowContent = `<tr id="rowId_` + count_num + `">
                                                <td>
                                                    <input readonly class="form-control-sm" type="text" id="excipient_name_` + count_num + `" name="excipient_name_` + count_num + `" value="` + ex_name + `" readonly required>
                                                    <input readonly class="form-control-sm" type="text" id="excipient_id_` + count_num + `" name="excipient_id_` + count_num + `" value="` + ex_id + `" readonly hidden>
                                                </td>
                                                <td>
                                                    <input readonly onchange="changeQuantity(this,` + ex_id + `)" type="number" class="form-control-sm" min="0.01" step="0.01" value="0.01" required>
                                                </td>
                                                <td>
            ...
            rowContent = `<tr id="rowId_` + count_num + `">
                                                <td>
                                                    <input readonly class="form-control-sm" type="text" id="unit_name_` + count_num + `" name="unit_name_` + count_num + `" value="` + unit_name + `" readonly required>
                                                    <input readonly class="form-control-sm" type="text" id="unit_id_` + count_num + `" name="unit_id_` + count_num + `" value="` + unit_id + `" readonly hidden>
                                                </td>
                                                <td>
                                                    <input readonly onchange="changeQuantity(this,` + unit_id + `)" type="number" class="form-control-sm" min="0.01" step="0.01" value="0.01" required>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input readonly onchange="changePrice(this,` + unit_id + `)" type="number" class="form-control-sm" min="0" step="0.01" value="0" required placeholder = "VNĐ">
            ...
            function submitForm() {
            document.getElementById("ConfirmProductForm").submit();
            }
            ...
            event.target.value = ''; // Clear the input readonly
            return;
            } else {
