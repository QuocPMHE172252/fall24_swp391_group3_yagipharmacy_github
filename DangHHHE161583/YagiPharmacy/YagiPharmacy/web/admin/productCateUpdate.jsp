                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="CategoryUpdate" id="updateCategoryForm" class="row">
                                        ...
                                        <input type="hidden" name="product_category_id" value="${cate.productCategoryId}" />

                                        <div class="form-group mb-3 col-md-6">
                                            <label for="product_category_code">Category Code</label>
                                            <input type="text" class="form-control" name="product_category_code" id="product_category_code"
                                                   value="${cate.productCategoryCode}" placeholder="Enter category code" required>
                                        </div>

                                        <div class="form-group mb-3 col-md-6">
                                            <label for="product_category_name">Category Name</label>
                                            <input type="text" class="form-control" name="product_category_name" id="product_category_name"
                                                   value="${cate.productCategoryName}" placeholder="Enter category name" required>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 col-md-6">
                                            ...
                                            <select class="form-select" name="product_category_parent_id"  id="productCategorySelect" onchange="handleCategoryChange()">
                                                ...
                                                <c:forEach var="c" items="${cl}">
                                                    <option value="${c.productCategoryId}" ${cate.productCategoryParentId ==c.productCategoryId ?"Selected":"" }  data-category-level="${c.productCategoryLevel}">${c.productCategoryName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>

                                        <div class="form-group mb-3 col-md-12">
                                            <label for="product_category_detail">Category Detail</label>
                                            <textarea class="form-control" name="product_category_detail" id="product_category_detail"
                                                      rows="3">${cate.productCategoryDetail}</textarea>
                                        </div>
